...
//     divConteiner.classList.add('member');
...
//
//     divConteiner.appendChild(divName);
//     divConteiner.appendChild(divSurname);
//     divConteiner.appendChild(divAge);
//     divConteiner.appendChild(divInfo);
...
for (const arrElement of coursesArray) {
    ...
    divTitle.innerText = arrElement.title;
    divTitle.classList.add('title');
    let divMonthDuration = document.createElement('div');
    divMonthDuration.innerText = arrElement.monthDuration;
    divMonthDuration.classList.add('monthDuration')
    let divHourDuration = document.createElement('div');
    divHourDuration.innerText = arrElement.hourDuration;
    divHourDuration.classList.add('hourDuration')
    let ulModules = document.createElement('ul');

    for (const ulModule of arrElement.modules) {
        let liElement = document.createElement('li');
        liElement.innerText = ulModule;
        ulModules.appendChild(liElement)
    }


    divConteiner.appendChild(divTitle)
    divConteiner.appendChild(divMonthDuration)
    divConteiner.appendChild(divHourDuration)
    divConteiner.appendChild(ulModules)
}
